...
#import "LaCantinaViewController.h"

@interface LaCantinaViewController ()

@end

@implementation LaCantinaViewController
...
{
    [super viewDidLoad];
    self.additionalInstructionsTextField.delegate = self;
...
- (IBAction)backgroundTouch:(id)sender {
    [self.additionalInstructionsTextField resignFirstResponder];
